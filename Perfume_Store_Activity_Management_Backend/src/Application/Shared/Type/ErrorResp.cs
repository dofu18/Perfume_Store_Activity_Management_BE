namespace Perfume_Store_Activity_Management_Backend.src.Application.DTOs.Shared.Type;

using Perfume_Store_Activity_Management_Backend.src.Application.Shared.Constant;
